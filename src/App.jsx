...
const GROUPS = [
  ...
  { id:"sleep", name:"SLEEP", src:"OURA", col:"#a78bfa", rows:[
    ...
    {k:"hrv",l:"HRV",u:"ms",hi:true},{k:"restingHR",l:"Resting HR",u:"bpm"},{k:"readiness",l:"Readiness",u:"/100"},
  ]},
  { id:"nutrition", name:"NUTRITION", src:"MYFITNESSPAL", col:"#34d399", rows:[
    ...
    {k:"carbs",l:"Carbs",u:"g"},{k:"fat",l:"Fat",u:"g"},{k:"fiber",l:"Fiber",u:"g"},{k:"water",l:"Water",u:"L"},
  ]},
